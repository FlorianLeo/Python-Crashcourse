...
with open(quelle) as q:
	...
	for each_row in reader:
		...
		# extract the low temperature
		# take the 7th element, index is 6 and store it as days_low
		days_low = int(each_row[6])
		# append it to the all_highs list
		all_lows.append(days_low)
...
ax.plot(all_dates, all_highs, c='red', alpha=0.5)
# Pass both lists to plot-function and colour the resulting line in red
ax.plot(all_dates, all_lows, c='blue', alpha=0.5)
ax.fill_between(all_dates, all_highs, all_lows, facecolor='violet', alpha=0.1)
