...
wuerfel_6_1 = Wuerfel()
wuerfel_10_1 = Wuerfel(10)

# Würfel werfen
ergebnisse = []
for wurfanzahl in range(50000):
	ergebnis = wuerfel_6_1.werfen() + wuerfel_10_1.werfen()
...
summe_flaechen = wuerfel_6_1.flaechen+wuerfel_10_1.flaechen
...
# Darstellung
meine_darstellung = Layout(title='Häufigkeitsverteilung 1 6-seitiger und 1 10-seitiger Würfel - 50000 Würfe.',
...
offline.plot({'data': daten, 'layout': meine_darstellung}, filename='wuerfel_6_10.html')