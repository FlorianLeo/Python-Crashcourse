...
# Würfel werfen
ergebnisse = []
for wurfanzahl in range(500000):
...
for wert in range(1, summe_flaechen+1):
...
# Darstellung
meine_darstellung = Layout(title='Häufigkeitsverteilung Multiplikation 2 6-seitiger Würfel - 50000 Würfe.',
...
offline.plot({'data': daten, 'layout': meine_darstellung}, filename='Tiy15-8.html')